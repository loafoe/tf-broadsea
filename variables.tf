...
variable "omop_data_hostname" {
  type        = string
  description = "The OMOP data hostname"
}

variable "omop_data_username" {
  type        = string
  description = "The OMOP data username"
}

variable "omop_data_password" {
  type        = string
  description = "The OMOP data password"
}

variable "users" {
  type        = list(string)
  description = "List of users to give access to the Broadsea container"
  default     = []
}
